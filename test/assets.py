...
for i,card in enumerate(cards):
    ...
    for suffix,size in [('',(72,116)),('~emery',(104,168)),('~gabbro',(104,168))]:
        b=(root/f'resources/data/art-{i}{suffix}.bin').read_bytes()
...
print('PASS: 78 source hashes, 156 exact text fields, 234 bitmaps, six packaged native targets')
